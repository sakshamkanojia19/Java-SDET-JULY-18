...
public class TestDataBaseTest {
	...
	// Logger object
	private static final Logger log = LogManager.getLogger(TestDataBaseTest.class);
	...
	public void readfromDBTest() throws ClassNotFoundException, SQLException, InterruptedException {
		...
		// In JDBC (Java Database Connectivity), a Statement object is an interface used to execute SQL statements against a relational database. 
		// It serves as a fundamental component for interacting with databases from Java applications.
