...
public class Scrolling {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Scroll to view Actions class moveTo element , Scrolling , ScrollToView
            // If elements are out of view port then we can use scroll
            // About amazone

            WebElement aboutamz = driver.findElement(By.xpath("//a[contains(text(),'About Amazon')]"));
