...
//    private By subjectsField = By.xpath("//input[@id='subjects']");
...
public class RegisterPage {
    ...
    // Locators (updated as per working E2E script)
    private By nameField = By.id("name");
    private By emailField = By.id("email");
    private By genderMale = By.xpath("(//input[@type='radio'])[1]");
    private By genderFemale = By.xpath("(//input[@type='radio'])[2]");
    private By genderOther = By.xpath("(//input[@type='radio'])[3]");
    private By mobileField = By.id("mobile");
    private By dobField = By.id("dob");
    private By subjectsField = By.id("subjects");
    private By hobbiesCheckboxes = By.xpath("//input[@type='checkbox'])[3]"); // all checkboxes
    private By pictureField = By.id("picture");
    private By addressField = By.id("currentAddress"); // corrected
    private By stateDropdown = By.id("state");
    private By cityDropdown = By.id("city");
    private By submitButton = By.xpath("//input[@value='Login']");
    private By successModal = By.xpath("//div[@class='modal-content']");
    ...
    public void selectGender(String gender) {
        ...
        switch (gender.toLowerCase()) {
            case "male":
                genderElement = wait.until(ExpectedConditions.elementToBeClickable(genderMale));
                break;
            case "female":
                genderElement = wait.until(ExpectedConditions.elementToBeClickable(genderFemale));
                break;
            case "other":
                genderElement = wait.until(ExpectedConditions.elementToBeClickable(genderOther));
                break;
            default:
                throw new IllegalArgumentException("Invalid gender: " + gender);
        }
    ...
    public void enterMobile(String mobile) {
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(mobileField));
        element.clear();
        element.sendKeys(mobile);
    }

    public void enterDOB(String dob) {
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(dobField));
        element.clear();
        element.sendKeys(dob);
    }

    public void enterSubjects(String subjects) {
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(subjectsField));
        element.clear();
    ...
    public void selectHobbies(List<String> hobbies) {
        for (String hobby : hobbies) {
            String hobbyXpath = "//label[text()='" + hobby.trim() + "']";
            WebElement element = wait.until(ExpectedConditions.elementToBeClickable( hobbiesCheckboxes));
            element.click();
        }
    }

    public void uploadPicture(String filePath) {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(pictureField));
